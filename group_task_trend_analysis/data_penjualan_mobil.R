...
# Menampilkan persamaan regresi metode semi rata-rata
semi_average_equation <- function(intercept, slope) {
  paste("Prediksi (Ŷ) = ", round(intercept, 2), " + ", round(slope, 2), " * Tahun (X)")
}

# Menampilkan persamaan
equation <- semi_average_equation(intercept, slope)
cat("Persamaan metode semi rata-rata untuk kasus ini:\n")
cat(equation, "\n")

# Menampilkan tabel hasil prediksi
cat("\nHasil Prediksi 5 Tahun ke Depan:\n")
print(future_years)
